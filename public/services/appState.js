  ...
  t(key) {
    const translations = {
      fr: {
        ...
        'positions.addTransaction': 'Ajouter',
        'positions.addTransactionTitle': 'Ajouter une transaction',
        ...
        'add.csvImportTitle': 'Import CSV Selfolio',
        'add.csvImportDesc': 'Importez les transactions depuis un fichier CSV exporté depuis Selfolio.',
      ...
      en: {
        ...
        'positions.total': 'Total',
        'positions.actions': 'Actions',
        'positions.addTransaction': 'Add',
        'positions.addTransactionTitle': 'Add Transaction',
        ...
        'add.csvImportTitle': 'Selfolio CSV Import',
        'add.csvImportDesc': 'Import transactions from a CSV file exported from Selfolio.',
